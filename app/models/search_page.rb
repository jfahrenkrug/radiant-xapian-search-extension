class SearchPage < Page
  ...
  tag 'highlight' do |tag|    
    ...
    if match
      ...
      helper.truncate(content, :length => length)
    end    
  end  
  
  #### "Behavior" methods ####
  def cache?
    # TODO this should actually be false. There is an ETag issue, though, see http://groups.google.com/group/radiantcms-dev/browse_thread/thread/ffef8357285ef61f
    true
  end
